...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 12-01-2022 a las 13:32:02
...
INSERT INTO `contactos` (`id_contacto`, `nombres`, `apellidos`, `tel1`, `tel2`, `dir`, `email`) VALUES
(3, 'Carla', 'Suarez', '0954120365', '022541258', 'La ajaví', 'c@c.c');
...
--
ALTER TABLE `contactos`
  MODIFY `id_contacto` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
COMMIT;
