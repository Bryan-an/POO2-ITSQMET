<%--
    Document   : Ejercicio9
    Created on : 24 dic. 2021, 07:54:48
    Author     : Bryan
--%>
...
<html>
    ...
    <body>
        <!-- 8. Solicitar al usuario tres números distintos y mostrar:
                a. Cual de los tres es el mayor
                b. Cual es el menor -->
        <div class="container w-50 my-5">
            <form action="./JSP/Ejercicio8.jsp" method="POST">
                <table class="table">
