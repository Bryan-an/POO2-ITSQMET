...
<html>
    ...
    <body>
        <div class="container my-5">
            ...
            <p class="text-center">
                Construir un programa que pida al usuario su fecha de nacimiento. Imprimir en
                pantalla que edad tiene exactamente hasta la fecha actual.
            </p>
            <div class="my-5">
                <form action="./JSP/Exercise19Back.jsp" method="GET">
                    <table class="table">
                        <tbody>
                            <tr>
                                <td>
                                    <label class="h3" for="birthdate">Ingrese su fecha de nacimiento:</label>
                                </td>
                                <td>
