...
<html>
    ...
    <body>
        <div class="container my-5">
            ...
            <p class="text-center"> Construir un programa que pida al usuario su color favorito, hallar la longitud
                de ese color e imprimir en pantalla todos los números pares desde el cero hasta
                la longitud del color.</p>
            <div class="my-5">
                <form action="./JSP/Exercise13Back.jsp" method="GET">
                    <table class="table">
                        <tbody>
                            <tr>
                                <td>
                                    <label class="h3" for="color">Ingrese su color favorito:</label>
                                </td>
                                <td>
